...
import mx.wen.pos.repository.PlanRepository
import mx.wen.pos.service.PlanService
...
class PlanServiceImpl implements PlanService {
  ...
  List<Plan> listarPlanesPorBancoDeposito( Integer idBancoDeposito ) {
    ...
    return new ArrayList<Plan>()//planRepository.findByIdBancoDeposito( idBancoDeposito ) ?: [ ]
  }
}
